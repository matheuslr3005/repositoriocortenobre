...
export const PECAS = [
  ...
  {
    id: 'carbono-madeira-lisa',
    nome: 'Faca carbono · cabo madeira',
    aco: 'carbono',
    modelo: 'ximango',
    polegadas: 9,
    lamina: '9" (229mm)',
    cabo: 'madeira',
    caboRotulo: 'Madeira',
    detalhe: 'Lâmina com acabamento de forja, sem gravação. Cabo em madeira com virola de alumínio.',
    preco: 19990,
    fotos: [F('carbono-madeira-lisa')],
  },
  {
    id: 'carbono-osso-lisa',
    nome: 'Faca carbono · cabo osso',
    aco: 'carbono',
    modelo: 'ximango',
    polegadas: 9,
    ...
    cabo: 'osso',
    caboRotulo: 'Osso',
    detalhe: 'Lâmina com acabamento de forja, sem gravação. Cabo em osso com virola de alumínio.',
    preco: 19990,
    fotos: [F('carbono-osso-lisa')],
  },
  {
    id: 'carbono-chifre-liso',
    nome: 'Faca carbono · cabo chifre',
    aco: 'carbono',
    modelo: 'ximango',
    polegadas: 9,
    ...
    cabo: 'chifre',
    caboRotulo: 'Chifre',
    detalhe: 'Lâmina com acabamento de forja, sem gravação. Cabo em chifre com virola de alumínio.',
    preco: 19990,
    fotos: [F('carbono-chifre-liso')],
  },
  {
    id: 'carbono-ram-chifre-b',
    nome: 'Faca carbono · cabo chifre',
    aco: 'carbono',
    modelo: 'ximango',
    polegadas: 9,
    ...
    cabo: 'chifre',
    caboRotulo: 'Chifre',
    detalhe: 'Lâmina com gravação da marca RAM. Cabo em chifre com espaçador de madeira.',
    preco: 19990,
    fotos: [F('carbono-ram-chifre-b')],
  },
  {
    id: 'carbono-brasao-chifre',
    nome: 'Faca carbono · cabo chifre',
    aco: 'carbono',
    modelo: 'ximango',
    polegadas: 9,
    ...
    cabo: 'chifre',
    caboRotulo: 'Chifre',
    detalhe: 'Lâmina com gravação de brasão. Cabo em chifre com espaçador de madeira.',
    preco: 19990,
    fotos: [F('carbono-brasao-chifre')],
  },
];
